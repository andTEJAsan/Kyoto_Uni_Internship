...
\title[Parallelizing LU Decomposition]{COL380 Assignment 1} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page

\subtitle{A Study on Parallelizing LU Decomposition} % Presentation subtitle, remove this command if a subtitle isn't required
...
\institute[IITD]{Indian Institute of Technology, Delhi \\ \smallskip \textit{}} % Your institution, the optional parameter can be used for the institution shorthand and will appear on the bottom of every slide after author names, while the required parameter is used on the title slide and can include your email address or additional information on separate lines
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{equation}
			x \sim y \Leftrightarrow x \equiv y \equiv 0 \mod 8
		\end{equation}
		\item Recently, a scalable algorithm for model counting over boolean constraints was propsed by Meel et al.
		...
		\item Applications include approximating the information lost as entropy by a given computer programme.
	\end{itemize}
\end{frame}
